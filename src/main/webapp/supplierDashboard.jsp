...
<head>
    ...
    <script>
        ...
        function filterItems() {
            var input = document.getElementById("itemNameFilter").value.toLowerCase();
            var rows = document.querySelectorAll("#itemsTable tbody tr");
            let count = 0;

            rows.forEach(row => {
                var itemName = row.cells[0].textContent.toLowerCase(); // Item Name is in first <td>
...
<div class="container">
    ...
    <input type="text" id="itemNameFilter" onkeyup="filterItems()" placeholder="Search by item name..." />
