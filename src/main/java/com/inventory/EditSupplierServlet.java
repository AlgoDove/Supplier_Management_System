...
public class EditSupplierServlet extends HttpServlet {
    private static final String SUPPLIER_FILE_PATH = "C:\\Users\\paves\\OneDrive\\Pictures\\my project\\Inventory_Stock_Management-Supplier\\src\\main\\webapp\\SupplierLoginCredentials.txt";
    private static final String SUPPLIER_INVENTORY_PATH = "C:\\Users\\paves\\OneDrive\\Pictures\\my project\\Inventory_Stock_Management-Supplier\\src\\main\\webapp\\suppliersInventory.txt";
    private static final String STOCK_INVENTORY_PATH = "C:\\Users\\paves\\OneDrive\\Pictures\\my project\\Inventory_Stock_Management-Supplier\\src\\main\\webapp\\stockInventory.txt";

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        HttpSession session = request.getSession();
        String supplierUsername = (String) session.getAttribute("supplierUsername");//Getting currently logged-in Supplier userName
        ...
        List<String> updatedLoginLines = new ArrayList<>(); //Hold the Updated Lines
        ...
        Files.write(Paths.get(SUPPLIER_FILE_PATH), updatedLoginLines, StandardOpenOption.TRUNCATE_EXISTING); //OverWrite the File
        ...
        List<String> updatedInventoryLines = new ArrayList<>();// Store Updated Lines
