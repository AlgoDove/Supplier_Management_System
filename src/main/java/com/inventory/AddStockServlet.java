...
public class AddStockServlet extends HttpServlet {
    private static final String SUPPLIER_INVENTORY_FILE = "C:\\Users\\paves\\OneDrive\\Pictures\\my project\\Inventory_Stock_Management-Supplier\\src\\main\\webapp\\suppliersInventory.txt";
    private static final String STOCK_INVENTORY_FILE = "C:\\Users\\paves\\OneDrive\\Pictures\\my project\\Inventory_Stock_Management-Supplier\\src\\main\\webapp\\stockInventory.txt";

    private SupplierInventoryManager inventoryManager;

    @Override
    public void init() throws ServletException { //it creates an instance of SupplierInventoryManager and passes in the file paths
        try {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            double price;
            try {
                quantity = Integer.parseInt(quantityStr);//convert input strings to valid numbers.
