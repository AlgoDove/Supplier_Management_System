...
import java.util.*;
                                                    // This declares an abstract generic class
public abstract class AbstractInventoryManager<T> {
    ...
    } //Overwrites the inventoryFile with the provided list of lines.
...
} //In SupplierInventoryManager, the key is the supplierUsername and entry is a StockEntry.
